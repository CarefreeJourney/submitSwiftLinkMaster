...
import com.lcl.swiftlink.admin.dao.entity.GroupUniqueDO;
import com.lcl.swiftlink.admin.dao.mapper.GroupMapper;
import com.lcl.swiftlink.admin.dao.mapper.GroupUniqueMapper;
import com.lcl.swiftlink.admin.dto.req.ShortLinkGroupSortReqDTO;
import com.lcl.swiftlink.admin.dto.req.ShortLinkGroupUpdateReqDTO;
import com.lcl.swiftlink.admin.dto.resp.ShortLinkGroupRespDTO;
...
import com.lcl.swiftlink.admin.toolkit.RandomGenerator;
...
import static com.lcl.swiftlink.admin.common.constant.RedisCacheConstant.LOCK_GROUP_CREATE_KEY;
...
public class LinkGroupServiceImpl extends ServiceImpl<GroupMapper, GroupDO> implements LinkGroupService {
    ...
    @Override
    public void saveLinkGroup(String groupName) {
        saveLinkGroup(UserContext.getUsername(), groupName);
    }

    @Override
    public void saveLinkGroup(String username, String groupName) {
